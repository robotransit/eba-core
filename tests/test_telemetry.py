...
class TestMakeStepId(unittest.TestCase):
    ...
    def test_zero_nonce_is_valid(self) -> None:
        """Zero deterministic_nonce is valid."""
        self.assertEqual(make_step_id("trace-abc", 0), "trace-abc:step:0")
...
class TestValidateEvent(unittest.TestCase):
    ...
    def test_all_valid_event_types_pass(self) -> None:
        """All six canonical event types pass validation."""
    ...
    def test_all_valid_severities_pass(self) -> None:
        """All four severity levels pass validation."""
...
class TestEmitEvent(unittest.TestCase):
    ...
    def test_default_eck_core_logger_used_when_none_provided(self) -> None:
        ...
        with patch(
            "eck.telemetry.logging.getLogger", return_value=default_logger
        ) as mock_get_logger:
            emit_event(
                "step.start",
                trace_id="trace-abc",
